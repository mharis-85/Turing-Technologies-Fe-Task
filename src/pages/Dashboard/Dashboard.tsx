...
export const Dashboard: FC<DashboardProps> = (props) => {
  ...
  if (calls.isError)
    return (
      <main
        className={`${className} bg-white flex-grow p-5 space-y-3 flex flex-col`}
      >
        <ErrorView />
      </main>
    );
  ...
  return (
    <main
      className={`${className} bg-white flex-grow p-8 space-y-3 flex flex-col`}
    >
      <section>
